...
\begin{figure}
  \begin{align*}
    ...
    sss & \in \SSS &\defined  &\text{list(ShareState)} \\
    ss & \in \text{ShareState} &\defined &\PID \times \VMID \times \VMID\\
...
\begin{figure}[h!]
  \begin{mathpar}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{v} ,\, (\delta s \text{ with }\{ [v].rs[\reg{pc}]=rs_v[pc]+1\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{v} ,\, (\delta s \text{ with }\{ [v].rs[rn]=w ; [v].rs[\reg{pc}]=rs_v[\reg{pc}]+1\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{rs_v[\reg{pc}]=rs_v[\reg{pc}]+1 ; rs_v[rn_1]=mm[\ta{rs_v[rn_2]}]\},mm,sss))}
...
\begin{figure}[h!]
  \begin{mathpar}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1\},mm~\text{with}~\{[a_s]=rs_v[rn_2]\},sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}] = rs_v[\reg{pc}]+1;[v].rs[rn_1]=rs_v[rn_2]+rs_v[rn_3]\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}] = rs_v[\reg{pc}]+1;[v].rs[\reg{NZ}]=1\},mm,sss))}

    \and \inferrule[Exec-cmp-Succ-Neg]
    {\text{AccessibleAddr}(\delta_v,a_i) \\\text{DecodeInstr}(mm[a_i],\mathtt{cmp}~rn_1~rn_2) \\ rn_1, rn_2\in \text{GenRegs}\\ rs_v[rn_1]-rs_v[rn_2]<0 }
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}] = rs_v[\reg{pc}]+1;[v].rs[\reg{NZ}]=2\},mm,sss))}

    \and \inferrule[Exec-cmp-Succ-Pos]
    {\text{AccessibleAddr}(\delta_v,a_i) \\\text{DecodeInstr}(mm[a_i],\mathtt{cmp}~rn_1~rn_2) \\ rn_1, rn_2\in \text{GenRegs}\\ rs_v[rn_1]-rs_v[rn_2]>0 }
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}] = rs_v[\reg{pc}]+1;[v].rs[\reg{NZ}]=0\},mm,sss))}
...
\begin{figure}[h!]
  \begin{mathpar}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{n} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1\},mm,sss))}

    \and \inferrule[Exec-hvc-Succ-Run-MsgSend]
    {\text{AccessibleAddr}(\delta_v,a_i) \\\text{DecodeInstr}(mm[a_i],\mathtt{hvc}) \\\text{IsFFA}(\delta_v,\tt{RUN}) \\ n=\text{to\_vmid}(rs_v[\reg{R1}]) \\v=0\\ \text{ValidVMID}(\delta s,n)\\n\ne0\\ \delta_n.mb.rx=(-,\TRUE,w_l,v_s) }
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{n} ,\, (\delta s \text{ with}\left\{{\begin{array}{l}[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1; \\ \null [n].rs[\reg{R0}]=\efid{MSG\_SEND}; \\ \null [n].rs[\reg{R1}]=\text{comb}(v_s,n);\\\null [n].rs[\reg{R3}]=w_l\end{array}}\right\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{v} ,\, (\delta s \text{ with}\left\{{\begin{array}{l}[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1; \\ \null [v].rs[\reg{R0}]=\efid{ERROR}; \\ \null [v].rs[\reg{R2}]=\eec{DENIED}\end{array}}\right\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow \\ (\EI{v} ,\, (\delta s \text{ with }\{[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1;[v].rs[\reg{R0}]=\efid{SUCC}\},mm,sss))}
    ...
    {(\EI{v} ,\,(\delta s,mm,sss)) \rightarrow (\EI{0} ,\, (\delta s \text{ with }\left\{{\begin{array}{l}[v].rs[\reg{pc}]=rs_v[\reg{pc}]+1;\\\null[0].rs[\reg{R0}]=\efid{YIELD};\\\null[0].rs[\reg{R1}]=\tw{v}\end{array}}\right\},mm,sss))}
  \end{mathpar}
\end{figure}
\begin{figure}
  \begin{mathpar}
...
\begin{figure}
  \begin{mathpar}
    ...
    {\text{AccessibleAddr}(\delta_v,a_i) \\\text{DecodeInstr}(mm[a_i],\mathtt{hvc}) \\\text{IsFFA}(\delta_v,\tt{MSG\_RECV})\\ \delta_v.mb.rx=(pid_r,\TRUE,-,-)}
