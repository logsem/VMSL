...
\begin{figure}[h!]
  \begin{adjustwidth}{-1cm}{}
    \begin{tabular}[t]{l|L L| L}
      Instr$(i)$ & \sema{i} & \text{where} & \text{Conditions} \\ \hline \hline
      \instr{fail}& \leftshift  (\DN{\mathtt{Fail}}, (\Delta,m,s)) & & \\ \hline
      \instr{halt}&\leftshift   (\DN{\mathtt{Halt}}, (\Delta,m,s))  & & \\\hline
      \instr{br} $r$&\leftshift \nextt(\Delta',m,s,\text{id},v,v)  & \Delta'[v].r[\mathtt{pc}]=\Delta[v].r[r]  &  \\\hline
      \multirow{2}{*}{\instr{bne} $r$}&\multirow{2}{*}{$\leftshift \nextt(\Delta',m,s,\text{id},v,v)$}
                               & \Delta'[v].r[\mathtt{pc}]= \Delta[v].r[r] & \Delta[v].r[\mathtt{NZ}].z=1 \\\cline{3-4}
                               & & \Delta'[v].r[\mathtt{pc}]= \Delta[v].r[\mathtt{pc}]+1 &\text{otherwise} \\\hline
      \instr{mov} $r$ $w$&\leftshift \nextt(\Delta', m, s,\updpc,v,v)  & \Delta'[v].r[r]=w & \\\hline
      ...
      \multirow{8}{*}{\instr{msgw}}& \multirow{8}{*}{$\nextt(\Delta', m, s,\updpc, v, v_n)$}
                                 & \SOME(p_r,b,w_s,v_s)=\Delta[v].\pi\\\cline{3-4}
                                 & &\!\!\!\!\!\begin{array}{l}
                                              v_n=v\\
                                              \Delta'[v_n].r[\mathtt{r_0}]=\MSGS\\
                                              \Delta'[v_n].r[\mathtt{r_1}]=v_s\\
                                 ...
                                 \end{array}& !b\\\hline
      \instr{msgs} $r_{1}$ $r_{2}$& \leftshift \nextt(\Delta', m', s,\updpc,v,v_n)
                                 &\!\!\!\!\!\begin{array}{l}
                                              v_r=\Delta[v].r[r_1]\\
                                              w_s=\Delta[v].r[r_2]\\
