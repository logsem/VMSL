  ...
  \begin{mathpar}
    ...
    \begin{aligned}
      \valida(\delta,r,P) &=\left\{ \begin{array}{ll}
                                  ...
                                  \end{array}
                                \right. \\
     \owned(\Delta,v,a) &=\left\{ \begin{array}{ll}
                                      \TRUE & \text{if} \; \pid(a) \in \Delta[v].ps \\
                                    \FALSE & \text{otherwise}
                                  \end{array}
                                \right. \\
      \pid(a) &= a >> \PPBITS
  ...
  \begin{adjustwidth}{-1cm}{}
    \begin{tabular}[t]{|l|L L|L|l|}
      ...
      &&\begin{array}{l}\Delta'[v].r[\mathtt{R0}]=\toword{ERROR}\\
          \Delta'[v].r[\mathtt{R2}]=\toword{INVAL\_PARA}\\
          s'=s
                                     \end{array}
      ...
      &&\begin{array}{l}\Delta'[v].r[\mathtt{R0}]=\toword{ERROR}\\
          ...
          s'=s
                                    ...
                                    &\leftshift\begin{array}{l}
                                                 h \neq 0
                                               \end{array} & \\\cline{3-4}
                                   &&\begin{array}{l} \Delta'[v].ps=\Delta[v].ps \setminus \{\pid(addr)\}  \\
                                       \!\!\!\!\begin{array}{ll}
                                                 s'=& s \append [(v_s,flag,\llen{s},\\
                                                 &tag,v_r,\pid(addr))]
                                                 \end{array}\\
