...
\begin{displaymath}
  \inferrule[wp-start]{}{
   \later \Phi(\mathsf{Done~Halt}) \asts \Sep_{j\in l} \wpre{\mathsf{Repeat~ExecInstr}~|~j}{v.\TRUE} \vdash \wpre{\mathsf{Start} ~ l~|~i}{v.\Phi(v)}
  }
\end{displaymath}
...
\begin{displaymath}
  \inferrule[ht-par-two]{
    \hoare{P_{i}}{\mathsf{Repeat~ExecInstr}~|~i}{\_.Q_{i}} \\
    \hoare{P_{j}}{\mathsf{Repeat~ExecInstr}~|~j}{\_.Q_{j}}
  }{
    \hoare{P_{i}\asts P_{j}}{\mathsf{Start} ~ [i,j] ~|~-1}{v.v=\mathsf{Done~Halt}\asts Q_{i}\asts Q_{j}}
  }
  \end{displaymath}
 ...
 % }\\
  ...
  \inferrule[wp-repeat-exec]{}{
    \wpre{\mathsf{ExecInstr}~|~i}{\mu.\wpre{\mathsf{Repeat~}\mu~|~i}{v.\Phi(v)} \lor \Phi(\mathsf{Done~Halt})}   \vdash \wpre{\mathsf{Repeat~ExecInstr}~|~i}{v.\Phi(v)}
  }
