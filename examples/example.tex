...
\clearpage
  ...
  \end{array} %TODO : add #2 to everywhere above
  }{hvc}
  \oneinstr{
  \begin{array}{l}
  ...
  \begin{array}{l}
            ...
            \rxpage{1}{a_{rx},\TRUE,9,0} \asts \adr{\pid(a_{rx})}{[0,0,w_{h},0,1,1,2,1,\addr(p,0),...]} \asts \\
            \sss{[w_{h}\leftarrow(0,0,0,[],[p],\efid{MEM\_LEND})]} \asts \ownGGhost{0} \asts\ownGGhost{1} \asts \#2
  \end{array} %TODO add R0_{1}, R1_{1}, and R3_{1} to everywhere above
    }{hvc}
    \oneinstr{
      \begin{array}{l}
  ...
  \end{array}%TODO: open the invariant again, two issues: 1. remember the sss 2. only resaon about the third disjunction
