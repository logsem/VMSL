...
\begin{sequencediagram}
    ...
    \begin{call}{VM0}{MEM\_DONATE}{Hyp}{SUCCESS}
    \end{call}
    
    \begin{call}{VM0}{MSG\_SEND}{Hyp}{SUCCESS}
    \end{call}
    
    \begin{call}{VM0}{RUN}{VM1}{YIELD}    
...
\begin{sequencediagram}
    ...
    \begin{call}{VM0}{RUN}{VM1}{MSG\_SEND}  
        \begin{call}{VM1}{MEM\_DONATE}{Hyp}{SUCCESS}
        \end{call}
        \begin{call}{VM1}{MSG\_SEND}{Hyp}{}
        \end{call}
    \end{call}
    
    \begin{call}{VM0}{RUN}{VM2}{YIELD}    
