...
From HypVeri.rules Require Import rules_base add.
...
Lemma ftlr_add {i mem_acc_tx ai regs rxs ps_acc p_tx p_rx instr trans op1 op2} P:
  ...
  decode_instruction instr = Some (machine.Add op1 op2) ->
