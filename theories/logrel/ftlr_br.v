...
From HypVeri.rules Require Import rules_base br.
...
Lemma ftlr_br {i mem_acc_tx ai regs rxs ps_acc p_tx p_rx instr trans op} P:
  ...
  decode_instruction instr = Some (Br op) ->
