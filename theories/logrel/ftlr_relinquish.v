...
Lemma ftlr_relinquish {i mem_acc_tx ai regs ps_acc p_tx p_rx instr trans rxs r0}:
  ...
  Proof.
    ...
    iApply ("IH" $! _ _ (<[r1 := ((tran.1, false):transaction)]> trans) _ Htotal_rxs Htotal_regs' with "[] [] [] [] regs tx pgt_tx pgt_acc
                            [pgt_owned] [fresh_handles trans pgt_tran tran] [tran_pgt_transferred] [retri retri' re re' tran'']
                            R0z R1z R2z rx rx_state other_rx prop0 propi [tran_pgt_owned]
