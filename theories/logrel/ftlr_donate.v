...
Lemma ftlr_donate {i mem_acc_tx ai regs ps_acc p_tx p_rx instr trans rxs r0}:
  ...
  Proof.
    ...
    { (* all pages are exclusively owned, ok to perceed *)
      ...
      iApply ("IH" $! _ (ps_acc∖ ps_donate) trans' _ Htotal_rxs Htotal_regs' with "[] [] [] [] regs tx pgt_tx pgt_acc [pgt_owned]
                [fresh_handles tran_donate trans pgt_donate_3] [tran_pgt_transferred tran_donate' pgt_donate_1] [retri tran_donate'' retri_donate] R0z R1z R2z
                rx rx_state other_rx prop0 propi [tran_pgt_owned]  [retri_owned] [mem_rest mem_acc_tx mem_tx]").
