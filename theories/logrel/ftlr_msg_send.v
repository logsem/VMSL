...
Section ftlr_msg_send.
  ...
  Proof.
    ...
    { (* apply [msg_send_full_rx] *)
      ...
      iDestruct ("Hacc_mem_acc_tx" with "[$mem_instr]") as "mem_acc_tx".
      iApply ("IH" $! _ ps_acc trans _ Htotal_rxs Htotal_regs' Hsubset_mb Hsubset_acc Hnin_rx Hnin_tx with "regs tx pgt_tx pgt_acc pgt_owned trans_hpool_global
                            tran_pgt_transferred retri R0z R1z R2z rx rx_state [other_rx rx_state_v] prop0 propi tran_pgt_owned retri_owned [mem_rest mem_acc_tx mem_tx]
                            ").
      {
    ...
    { (* instruction is in ps_oea *)
      ...
      { solve_finz + n0. }
      {
        ...
        iSplitL "trans_hpool_global trans_pgt_transferred retri R0z R1z R2z rx rx_state other_rx mem_tran mem_rx_v rx_v rx_state_v propi".
        ...
        iExists r2, v, p_rx_v.
        iFrame "rx_v".
        iFrame. iExists (list_to_map (zip (finz.seq p_rx_v (length des)) des) ∪ mem_rx_v). iFrame.
        iSplitR "R1z".
    ...
    { (* tpa ai ∉ ps_acc ∖ ({[p_rx]} ∪ ps_mem_in_trans) *)
      ...
      { solve_finz + n0. }
      {
        ...
        { set_solver +. }
        rewrite Heq_inter_diff_union.
        iSplitL "trans_hpool_global trans_pgt_transferred retri R0z R1z R2z rx rx_state other_rx mem_tran rx_v rx_state_v mem_rx_v propi".
        iExists trans. iFrame "trans_hpool_global trans_pgt_transferred retri rx".
