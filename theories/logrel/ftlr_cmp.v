...
From HypVeri.rules Require Import rules_base cmp.
...
Lemma ftlr_cmp {i mem_acc_tx ai regs rxs ps_acc p_tx p_rx incmp trans arg1 arg2} P:
  ...
  tpa ai ∈ ps_acc ∖ {[p_tx]} ->
  mem_acc_tx !! ai = Some incmp ->
  decode_instruction incmp = Some (Cmp arg1 arg2) ->
