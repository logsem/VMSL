...
Program Instance run_yield_with_unknown_vmconfig : HypervisorConstants :=
    {vm_count := 3;
     vm_count_pos:= _}.
...
Section run_yield_with_unknown.
  ...
  Proof.
    iIntros (HIn HaccIn) "((p_1 & p_2 & p_3 & p_4 & _) & Hprop0 & Hprop1 & Hprop2 & Hacc & PCz & R0z & R1z)".
  ...
  Lemma run_yield_with_unknown_spec q1 q2 prog1page prog2page sacc1 sacc2 :
      prog1page ≠ prog2page ->
      seq_in_page (of_pid prog1page) (length program1) prog1page ->
      V0 ∈ sacc1 ->
      seq_in_page (of_pid prog2page) (length program2) prog2page ->
  ...
  Proof.
    iIntros (Hpne HInz HpInz HIni HpIni) "(Hprogz & Hprogi & Hprop0 & Hprop1 & Hprop2 & Haccz & Hacci & PCz & PCi & R0z & R1z & R0i)".
    iDestruct (VMProp_split with "Hprop1") as "[Hprop1 Hprop1']".
    iSplitL  "Hprogz Haccz PCz R0z R1z Hprop0 Hprop1 Hprop2".
    - iIntros "_".
