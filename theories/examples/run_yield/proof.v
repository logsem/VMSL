...
Section run_yield.
  ...
  Lemma machine_0_spec {q1 prog1page} :
  ...
  Proof.
    iIntros (HIn) "((p_1 & p_2 & p_3 & p_4 & _) & Hprop0 & Hprop1 & Hacc & PCz & R0z & R1z)".
  ...
  Lemma machine_1_spec {q1 prog2page} :
      ...
      (program program2 (of_pid prog2page))
        ...
        ⊢ VMProp_holds V1 (1/2)%Qp -∗ (WP ExecI @ V1
              {{ (λ m, False)}}%I).
  Proof.
    iIntros (HIn) "((p_1 & p_2 & _) & HPropi & Hacc & PCi & R0i)".
    iIntros "HPropH".
  ...
  Lemma run_yield_spec q1 q2 prog1page prog2page:
      prog1page ≠ prog2page ->
      seq_in_page (of_pid prog1page) (length program1) prog1page ->
      seq_in_page (of_pid prog2page) (length program2) prog2page ->
      program (program1) (of_pid prog1page) ∗
  ...
  Proof.
    iIntros (Hpne HInz HIni) "(Hprogz & Hprogi & Hprop0 & Hprop1 & Haccz & Hacci & PCz & PCi & R0z & R1z & R0i)".
