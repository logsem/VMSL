...
Lemma  mem_send_nz_update{i ai wi sown sacc sexcl r0 r1 r2 ptx sh q h fhs j psd spsd } {l:Word}  σ1 tt:
  ...
  gen_vm_interp
    (update_incr_PC (update_reg (update_reg
      (update_access_batch (insert_transaction σ1 h (i, W0, false, j, psd, tt)) psd NoAccess) R0
...
Lemma hvc_mem_send_nz tt instr i wi r2 pi ptx sown q sacc sexcl des sh hvcf  (l :Word) (spsd: gset PID)
  ...
  ∗ mem_region des ptx}}}.
Proof.
  iIntros (Hinstr Hdecodei Hini Hdecodef Hismemsend Hneq Hlenpsd Hdesc Hindesc Hlenr1 Hspsd Hsacc Hsown Hsexcl Hshne).
  ...
  - (* step *)
    ...
    destruct hvcf; try inversion Hismemsend;subst tt;
    destruct HstepP;subst m2 σ2; subst c2; simpl.
    { iDestruct (mem_send_nz_update with "PC Hai Hown Hacc Hexcl R0 R1 R2 Hhp
...
Proof.
  ...
  iApply ((hvc_mem_send_nz Donation instr i wi r2 pi ptx sown q sacc sexcl des sh Donate l spsd ai r0 r1 j psd));auto.
Qed.
...
Proof.
  iIntros (Hinstr Hdecodei Hini Hdecodef Hneq Hlenpsd Hdesc Hindesc Hlenr1 Hspsd Hsacc Hsown Hsexcl Hshne Φ ).
  iApply ((hvc_mem_send_nz Sharing instr i wi r2 pi ptx sown q sacc sexcl des sh Share l spsd ai r0 r1 j psd));auto.
Qed.
...
Proof.
  iIntros (Hinstr Hdecodei Hini Hdecodef Hneq Hlenpsd Hdesc Hindesc Hlenr1 Hspsd Hsacc Hsown Hsexcl Hshne Φ ).
  iApply ((hvc_mem_send_nz Lending instr i wi r2 pi ptx sown q sacc sexcl des sh Lend l spsd ai r0 r1 j psd));auto.
Qed.
